...
def test_binary_classification_matches_git_for_every_tracked_file():
    ...
    reported green for it. Against `4b825dc…` the diff is the whole index -- 169 files, 35 of
    ...
    # was the old floor, and it is satisfied by checking a single file out of 169: a diff against
