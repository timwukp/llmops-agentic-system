...
`1071 passed, 0 failed` (26.8s). Negative controls **222/222** (190 mutations, 222 pairs,
222 printed PASS lines, 0 FAIL, 0 SKIP-BROKEN, runner exit 0). Redaction scan clean, 163
...
- **`timeout` does not exist on macOS**, and `cmd > log; echo "EXIT: $?"` after a redirect
  ...
  the printed PASS-line count against the documented number (222 here).
