...
| Step Functions | llmops-pipeline (STANDARD) | deploy/07_lambdas.py | 26 states; 12 harness tasks on the happy path incl. EvalGenerate/EvalScore and MonitorHealth/MonitorReport, plus the remediation loop |
