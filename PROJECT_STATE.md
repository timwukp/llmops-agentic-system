...
| Step Functions | llmops-pipeline (STANDARD) | deploy/07_lambdas.py | 28 states; 12 harness tasks on the happy path incl. EvalGenerate/EvalScore and MonitorHealth/MonitorReport, plus the finetune remediation loop and the eval-job retry loop |
