...
| 反向控制 —— 逐一破壞每道 guard，確認它會失敗 | **148/148 反向控制** | `.venv/bin/python tests/negative_controls/monitor_dispatch.py` |
...
失敗 —— **148/148 反向控制**,129 個 mutation 斷言 148 組（guard, mutation）配對,runner 各印
